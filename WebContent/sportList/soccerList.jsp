...
.soccer_mainpic{
	...
	height: 200px;
	margin: 10px auto;
	background-image: url("../img/soccer_one.jpg");
...
<%
	...
	String sid_soccer = (String) session.getAttribute("sid");
				...
				<div id="pagetop">
						...
						<div id="history">
							<a class="home" href="/semi_Jungo/index.jsp" title="Home"><img alt="home" src="../img/home_s.png"></a> &gt; <a
								...
								href="/semi_Jungo/sportList/soccerList.jsp">Soccer</a>
						</div>
				</div>
				<div id="content">
	<div class="soccer_mainpic">
	</div>
 ...
 [<%=scarr.size()%>]
						...
						<td align="center"><div id="tag">
								...
								<ul>
									...
									<%
										if (!(arr.get(i).getWriter().equals(sid_soccer))) {
									%>
									<li><a
				...
				<tfoot>
					<tr>
						<td colspan="7" align="center">
							...
							%> <a
							href="soccerList.jsp?cp=<%=(userGroup - 1) * pageSize + pageSize%>&orderby=<%=orderby%>">&lt;&lt;</a>
							<%
								}
								for (int i = (userGroup * pageSize + 1)/*시작수를 현재 페이지로*/; i <= (userGroup * pageSize + pageSize); i++) {
							%> &nbsp;&nbsp;<a
							href="soccerList.jsp?cp=<%=i%>&orderby=<%=orderby%>"><%=i%></a>&nbsp;&nbsp;
							<%
								if (i == totalPage)
										break;
								}
							...
							%><a
							href="soccerList.jsp?cp=<%=(userGroup + 1) * pageSize + 1%>&orderby=<%=orderby%>">&gt;&gt;</a>
							<%
								}
							%>
						</td>
