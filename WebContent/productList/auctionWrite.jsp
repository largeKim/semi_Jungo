...
<section>
	<article>
		<h2>경매물품 올리기</h2>
		<form name="productWrite" action="auctionWrite_ok.jsp">
		<input type="hidden" name="writer" value="<%=sid%>">
			...
			<table class="p_WriteTable">
				...
				<tr>
					<th>경매 종료일</th>
					<td colspan="2" class="Write_td1" width="400px">
				...
				<tr>
					<th>경매 시작가격</th>
					<td  class="Write_td2"><input type="number" name="price" required min="1000" step="1000"></td>
					<th>즉시 구매 가격</th>
