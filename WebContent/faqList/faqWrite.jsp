...
<body>
	...
	<section>
		<article>
			<h2>자주묻는질문 글쓰기</h2>
			<form name="faqWrite" action="faqWrite_ok.jsp">
				<input type="hidden" name="writer" value="<%=sid%>"> <input
					type="hidden" name="type" value="공지">
				<table class="p_WriteTable">
					...
					<tr>
						<td colspan="2" align="center" style="border: hidden;"><input
							type="submit" value="글쓰기" class="writebt"> <input
							type="reset" value="다시" class="writebt"></td>
					</tr>
				</table>
			</form>
		</article>
