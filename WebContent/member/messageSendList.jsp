...
<article>
	...
	<table class="msg">
		...
		<tbody>
		<%
		ArrayList<MessageDTO> arr = medao.messageSendlist(cp, listSize,sid);
...
if(userGroup!=0){
	%>
	<a href="messageSendList.jsp?cp=<%=(userGroup-1)*pageSize+pageSize%>">&lt;&lt;</a>
	<%
}
for(int i=(userGroup*pageSize+1); i<=(userGroup*pageSize+pageSize); i++){
	%>
	&nbsp;<a href="messageSendList.jsp?cp=<%=i%>"><%=i%></a>&nbsp;
	<%
	if(i==totalPage)break;
}
if(userGroup!=(totalPage/pageSize-(totalPage%pageSize==0?1:0))){
	%>
	<a href="messageSendList.jsp?cp=<%=(userGroup+1)*pageSize+1 %>">&gt;&gt;</a>
	<%
}
%>
				</td>
